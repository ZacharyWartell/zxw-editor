...
- zxw-editor.html can be opened as a local file in Chrome.  Then resulting HTML page can be edited in Chrome and then saved to the same or another local .html file.
